...
|Configurer un serveur SMTP pour activer une communication entrante et sortante de Dynamics NAV par courriel.| [Procédure : configurer l'adresse de courriel manuellement ou à l'aide de la configuration assistée](madeira-how-setup-email.md)|  
