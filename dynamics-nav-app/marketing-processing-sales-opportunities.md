...
|--------------------------|-----|
|Tous les représentants et contacts|Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, entrez **Liste des opportunités**, puis sélectionnez le lien connexe.|
