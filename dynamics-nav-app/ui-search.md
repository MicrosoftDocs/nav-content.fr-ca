...
Vous pouvez rechercher des pages ou des rapports par l'intermédiaire du champ **Page ou rapport pour la recherche** dans le coin supérieur droit de la barre d'adresses.

Si vous utilisez [!INCLUDE[d365fin](includes/d365fin_md.md)] dans un navigateur, recherchez plutôt l'icône **Page ou rapport pour la recherche**.
