...
| Configurer le connecteur Dynamics NAV |Configure une connexion à Dynamics 365 for Sales, ce qui vous permet de synchroniser les données telles que les contacts et les informations des documents de vente. |
