...
**Astuce** : si vous complétez le champ **N° assurance** dans le journal GL immobilisation lorsque vous reportez un coût d'acquisition, Dynamics NAV reporte également le coût d'acquisition de l'immobilisation dans le livre couverture d'assurance. Pour en savoir plus, voir [Procédure : assurer des immobilisations](fa-how-insure.md).
