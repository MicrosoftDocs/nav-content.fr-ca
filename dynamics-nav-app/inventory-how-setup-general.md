...
---
# <a name="how-to-set-up-general-inventory-information"></a>Procédure : configurer des informations générales relatives à l'inventaire
...
Vous pouvez inclure un délai entrepôt par défaut pour votre inventaire dans la fenêtre **Configuration inventaire** ou pour votre emplacement dans le calcul de la promesse de livraison sur la ligne achat. Pour plus d'informations, voir [Procédure : calculer des dates promesse livraison](sales-how-to-calculate-order-promising-dates.md).  
