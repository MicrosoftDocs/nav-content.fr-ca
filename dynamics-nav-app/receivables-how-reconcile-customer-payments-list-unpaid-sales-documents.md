...
Si vous avez convenu d'un escompte de paiement avec votre client, les montants paiement peuvent être inférieurs aux montants facture si le paiement est effectué avant la date d'escompte convenue.
...
3. Renseignez les autres champs de la ligne journal général, tel que le montant et le numéro de client ou d'autres informations du relevé de compte bancaire. Pour plus d'informations, reportez-vous à [Procédure : utilisation des feuilles comptabilité](ui-work-general-journals.md).
