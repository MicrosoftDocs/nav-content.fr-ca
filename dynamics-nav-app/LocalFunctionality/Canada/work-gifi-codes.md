...
Dans [!INCLUDE[navnow](../../includes/navnow_md.md)], vous devez configurer des codes IGRF pour les comptes GL, les rapports, les bilans, les états de résultats et les relevés de bénéfices non répartis.
