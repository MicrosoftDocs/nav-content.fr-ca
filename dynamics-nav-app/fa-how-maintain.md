...
## <a name="to-view-maintenance-ledger-entries"></a>Pour visualiser des écritures du registre d'entretien
Vous pouvez également étudier les coûts d'entretien en visualisant les écritures du registre d'entretien.  
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, entrez **Immobilisations**, puis sélectionnez le lien connexe.
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets"></a>Pour afficher ou imprimer les écritures du registre d'entretien pour plusieurs immobilisations  
