...
Vous affectez une immobilisation à une police d'assurance en reportant sur le livre couverture d'assurance.
...
5. Ouvrez le journal assurance pertinent, examinez les valeurs créées, puis reportez-les sur le livre couverture d'assurance.
...
5. Pour visualiser les écritures couverture assurance, sélectionnez une valeur dans la matrice.
